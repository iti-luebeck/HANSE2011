    ...
    ui(new Ui::TaskPipeFollowingForm)
{
    ...
    // Navigation settings
    this->ui->useNavigation->setChecked(taskpipefollowing->getSettingsValue("useStartNavigation").toBool());
    this->ui->navPipeStartInput->setText(this->taskpipefollowing->getSettingsValue("pipeNavStart").toString());
    this->ui->navPipeEnd1Input->setText(this->taskpipefollowing->getSettingsValue("pipeNavEnd1").toString());
    this->ui->navPipeEnd2Input->setText(this->taskpipefollowing->getSettingsValue("pipeNavEnd2").toString());
...
void TaskPipeFollowingForm::on_applyButton_clicked(){
    ...
    // Navigation settings
    this->taskpipefollowing->setSettingsValue("useStartNavigation", this->ui->useNavigation->isChecked());
    this->taskpipefollowing->setSettingsValue("pipeNavStart", this->ui->navPipeStartInput->text());
    this->taskpipefollowing->setSettingsValue("pipeNavEnd1", this->ui->navPipeEnd1Input->text());
    this->taskpipefollowing->setSettingsValue("pipeNavEnd2", this->ui->navPipeEnd2Input->text());
